...
$(DESTDIR)pulses_gene.partslist_by_refdes.txt : $(SRCDIR)pulses_gene_analog.sch $(SRCDIR)pulses_gene_numeric.sch 
	$(NETLIST_PROG) -g partslist1 -o $(DESTDIR)pulses_gene.partslist_by_refdes.txt $(SRCDIR)pulses_gene_analog.sch $(SRCDIR)pulses_gene_numeric.sch 

$(DESTDIR)pulses_gene.partslist_by_value.txt : $(SRCDIR)pulses_gene_analog.sch $(SRCDIR)pulses_gene_numeric.sch 
	$(NETLIST_PROG) -g partslist3 -o $(DESTDIR)pulses_gene.partslist_by_value.txt $(SRCDIR)pulses_gene_analog.sch $(SRCDIR)pulses_gene_numeric.sch
